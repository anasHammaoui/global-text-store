    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
           {t.header?.title || "Discover Your Style with Our New Arrivals"}
          </motion.h2>
          <motion.p
          ...
          >
            {t.header?.description ||
              "Explore our latest collection of fashion items that redefine style and comfort. Shop now to elevate your wardrobe with the newest trends."}
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
          ...
          >
            <div className="flex flex-col">
              ...
              <span className="text-xs xl:text-base text-black/60 text-nowrap">
                {t.header?.stats?.internationalBrands || "International Brands"}
              </span>
            </div>
            <Separator
            ...
            <div className="flex flex-col ml-6 md:ml-0">
              ...
              <span className="text-xs xl:text-base text-black/60 text-nowrap">
                {t.header?.stats?.highQualityProducts || "High-Quality Products"}
              </span>
            </div>
            <Separator
            ...
            <div className="flex flex-col w-full text-center sm:w-auto sm:text-left mt-3 sm:mt-0 sm:ml-6 md:ml-0">
              ...
              <span className="text-xs xl:text-base text-black/60 text-nowrap">
                {t.header?.stats?.happyCustomers || "Happy Customers"}
              </span>
            </div>
          </motion.div>
        </section>
